...
barcamp.program = function() {
    ...
    function fixedHeader() {
        if(viewportWidth <= 768) {
            ...
            var topofDiv = $('.program-header').offset().top;
            ...
            $(window).scroll(function(){
                ...
                if($(window).scrollTop() >= topofDiv){
                    if(!$('.program-header').hasClass('fixed')) {
                        $('.program-header').addClass('fixed');
                    }
                    $('.program-header').css( "top", scroll+"px" );
                }
                else{
                    if($('.program-header').hasClass('fixed')) {
                        $('.program-header').removeClass('fixed');
                    }
                }
            });
        }
